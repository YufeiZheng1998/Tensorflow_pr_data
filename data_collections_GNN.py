...
csv_columns = ['pr_id','pr_title','pr_body', 'requester', 'pr_commenters', 'pr_comments', 'original_reviewers', 'active_reviewers', 'assignees', 'commits_messages','changed_files','created_at']
...
with open(csv_file, 'a+') as csvfile:
  ...
  while True:
    try:
      ...
      # Process changed files(Probably do not need this one)..
